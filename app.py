...
df_map = df[["location_name","Grades_final_text","primary_address_line_1","LATITUDE","LONGITUDE","Personal Attention and Support","Student-Teacher Trust","Administrative_District_Name"]]
...
fig = px.scatter_mapbox(filtered_df, 
                        ...
                        hover_data=["location_name","Grades_final_text","Personal Attention and Support (Normalized)","Student Teacher Trust (Normalized)","primary_address_line_1"],
